...
public class ComplaintsDAOtest {
    ...
    void create_Complaints_test() {
        Complaints complaints = new Complaints(1, "The Brume needs to be better maintained", Status.UNREVIEWED, -1);
    ...
    void get_all_complaints_test() {
        Complaints com1 = new Complaints(1, "The Brume needs to be better maintained", Status.UNREVIEWED, -1);
        Complaints com2 = new Complaints(2, "Church is gaining too much influence",  Status.UNREVIEWED, -1);
